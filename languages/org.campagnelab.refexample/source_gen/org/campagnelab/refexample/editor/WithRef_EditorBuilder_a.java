...
/*package*/ class WithRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    style.set(StyleAttributes.NAVIGATABLE_SREFERENCE, LINKS.ref$oHCk);
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.ref$oHCk;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.ref$oHCk);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.ref$oHCk);
    }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink ref$oHCk = MetaAdapterFactory.getReferenceLink(0x85d7c0cc4aa84799L, 0x8fbab6f80d065fa5L, 0x386faece7275f6bbL, 0x386faece7275f6bcL, "ref");
  }
