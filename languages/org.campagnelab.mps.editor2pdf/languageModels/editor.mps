...
<model ref="r:d002ba66-2d70-4764-a082-2db8090ec9a3(org.campagnelab.mps.editor2pdf.editor)">
  ...
  <imports>
    ...
    <import index="ha1n" ref="r:117db92d-261b-4ba2-97fe-04df0369434b(org.campagnelab.mps.editor2pdf.behavior)" implicit="true" />
  </imports>
  <registry>
            ...
            <node concept="3clFbS" id="324BXkoAPAI" role="2VODD2">
              <node concept="3cpWs8" id="324BXkoAYug" role="3cqZAp">
                <node concept="3cpWsn" id="324BXkoAYuh" role="3cpWs9">
                  ...
                  <node concept="2OqwBi" id="324BXkoAYui" role="33vP2m">
                    <node concept="35c_gC" id="324BXkoAYuj" role="2Oq$k0">
                      <ref role="35c_gD" to="3t4d:7_Pg6u6xjfG" resolve="EditorAnnotation" />
                    </node>
                    <node concept="2qgKlT" id="324BXkoAYuk" role="2OqNvi">
                      <ref role="37wK5l" to="ha1n:Hy99RD2Sbe" resolve="getDefaultJetBrainsMonoFont" />
                    </node>
                  </node>
                </node>
              </node>
